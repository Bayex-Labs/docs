...
The **Conditional Tokens Framework (CTF)** is an oracle-agnostic protocol for combinatorial prediction markets. Bayex builds upon this to enable liquid trading of these outcomes.
